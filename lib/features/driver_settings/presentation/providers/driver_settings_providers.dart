...
import 'package:flavorizr/features/driver_settings/data/datasources/driver_settings_remote_datasource.dart';
import 'package:flavorizr/features/driver_settings/data/repositories/driver_settings_repository_impl.dart';
...
final driverSettingsRepositoryProvider = Provider<DriverSettingsRepository>((ref) {
  ...
  return DriverSettingsRepositoryImpl(remoteDataSource: remoteDataSource, networkInfo: networkInfo);
});

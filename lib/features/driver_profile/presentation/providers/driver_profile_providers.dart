...
import 'package:flavorizr/features/driver_profile/data/repositories/driver_profile_repository_impl.dart';
import 'package:flavorizr/features/driver_profile/domain/repositories/driver_profile_repository.dart';
import 'package:flavorizr/features/driver_profile/domain/usecases/delete_driver_document_usecase.dart';
import 'package:flavorizr/features/driver_profile/domain/usecases/get_driver_documents_usecase.dart';
import 'package:flavorizr/features/driver_profile/domain/usecases/get_driver_profile_usecase.dart';
import 'package:flavorizr/features/driver_profile/domain/usecases/get_driver_vehicle_usecase.dart';
import 'package:flavorizr/features/driver_profile/domain/usecases/update_driver_profile_usecase.dart';
import 'package:flavorizr/features/driver_profile/domain/usecases/update_driver_vehicle_usecase.dart';
import 'package:flavorizr/features/driver_profile/domain/usecases/upload_driver_document_usecase.dart';
import 'package:flavorizr/features/driver_profile/presentation/controllers/driver_profile_controller.dart';
...
final getDriverProfileUseCaseProvider = Provider<GetDriverProfileUseCase>((ref) {
  return GetDriverProfileUseCase(
...
final getDriverVehicleUseCaseProvider = Provider<GetDriverVehicleUseCase>((ref) {
  return GetDriverVehicleUseCase(
    ref.watch(driverProfileRepositoryProvider),
  );
});

/// Provider for UpdateDriverVehicleUseCase.
final updateDriverVehicleUseCaseProvider =
    Provider<UpdateDriverVehicleUseCase>((ref) {
...
final getDriverDocumentsUseCaseProvider =
    Provider<GetDriverDocumentsUseCase>((ref) {
  return GetDriverDocumentsUseCase(
    ref.watch(driverProfileRepositoryProvider),
  );
});

...
class ConsumerSendVerificationCodeParametersBuilder
  ...
  ConsumerSendVerificationCodeParametersBuilder phoneIsoCode(String phoneIsoCode) {
    _phoneIsoCode = phoneIsoCode;
    return this;
  }

  /// Set the cancel token for request cancellation
  ConsumerSendVerificationCodeParametersBuilder cancelToken(CancelToken cancelToken) {

...
import 'package:flavorizr/features/trip/presentation/widgets/trip_type_card.dart';
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              Navigator.pop(context);
              final success = await ref.read(tripControllerProvider.notifier).cancelTrip(tripId);
              if (success && mounted) {

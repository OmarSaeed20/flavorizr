...
abstract class CompanyAuthRepository {
  ...
  Future<ApiResult<void>> sendVerificationCode(CompanySendVerificationCodeParameters parameters);

  /// Verify company phone with confirmation code
  Future<ApiResult<AuthTokens>> verifyPhone(CompanyVerifyPhoneParameters parameters);

  /// Initiate password reset
  Future<ApiResult<void>> forgetPassword(CompanyForgetPasswordParameters parameters);

  /// Reset password with verification code
  Future<ApiResult<void>> resetPassword(CompanyResetPasswordParameters parameters);

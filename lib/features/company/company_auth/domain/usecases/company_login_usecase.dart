...
class CompanyLoginUseCase {
  ...
  Future<ApiResult<AuthTokens>> execute(CompanyLoginParameters parameters) async {
    ...
    if (parameters.firebaseToken.isEmpty) {
      return ApiResult.failure(const ValidationException(message: 'Firebase token is required'));
    }

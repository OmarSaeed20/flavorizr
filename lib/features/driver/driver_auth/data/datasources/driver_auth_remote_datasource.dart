...
import 'package:fast_golden_taxi/features/driver/driver_auth/data/endpoints/driver_auth_endpoints.dart';
...
abstract class DriverAuthRemoteDataSource {
  ...
  Future<ApiResult<DriverCredentialsModel>> login(
    DriverLoginParameters parameters,
  );

  /// Registers a new driver.
  /// Endpoint: POST /driver/auth/register
  Future<ApiResult<DriverCredentialsModel>> register(
    DriverRegisterParameters parameters,
  );
  ...
  Future<ApiResult<void>> resetPassword(
    ResetDriverPasswordParameters parameters,
  );
...
class DriverAuthRemoteDataSourceImpl
  ...
  Future<ApiResult<DriverCredentialsModel>> login(
    ...
    return post<DriverCredentialsModel>(
      ...
      decoder: (data) =>
          DriverCredentialsModel.fromJson(data as Map<String, dynamic>),
    );
  }
  ...
  Future<ApiResult<void>> forgetPassword({required String phone}) async {
    return post<void>(
      path: DriverAuthEndpoints.forgetPassword,
      data: {'phone': phone},
    );
  }
  ...
  Future<ApiResult<void>> resetPassword(
    ...
    return post<void>(
      path: DriverAuthEndpoints.resetPassword,
      data: parameters.toJson(),
    );
  }
